        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label>Gender</label>
                        <p class="form-control-static"><?php echo $row["d_gender"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Address</label>
                    ...
                    <div class="form-group">
                        <label>Amount</label>
                        <p class="form-control-static"><?php echo $row["d_amount"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Method</label>
                        <p class="form-control-static"><?php echo $method; ?></p>
                    </div>
                    <p><a href="donations.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>        
        </div>
    </div>
